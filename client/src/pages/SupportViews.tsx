  ...
  return (
    <div className="max-w-md mx-auto py-20 px-6 text-center space-y-6 animate-in fade-in duration-200">
      ...
      <div className="flex flex-col gap-2 pt-2">
        <Link to="/" className="bg-[#088505] text-white font-bold font-mono py-3 rounded-xl text-xs uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer">
